(function () {
  ...
  var User = {
    ...
    template: (
      ...
      '<p>My username is: <b expr7="expr7"> </b></p>',
      [
        {
  ...
  var Sidebar = {
    css: `sidebar .row,[is="sidebar"] .row{ border: 2px solid black; }`,
      ...
      [
        {
          ...
          evaluate: _scope => _scope.state.showUser,
          redundantAttribute: 'expr1',
          selector: '[expr1]',

          template: template(
            '<user expr2="expr2"></user>',
            [
              {
                type: bindingTypes.TAG,
                getComponent: getComponent,
                evaluate: _scope => 'user',
                slots: [],
          ...
          expressions: [
            {
              ...
              name: 'onclick',
              evaluate: _scope => _scope.toggleUser
            }
          ]
        }
      ]
  ...
  var MyWindow = {
    css: `my-window .window,[is="my-window"] .window{ width: 90vw; margin-left: 5vw; margin-right: 5vw; border: var(--primary); }`,
    ...
    exports: {
      ...
      toggleCollapse() {
        // Lógica para colapsar/expandir la ventana
      }
    },
    ...
    template: (
      ...
      '<div class="window"><div class="header"><details><summary>Accordion 1</summary><p>Lorem</p></details><details open><summary>Accordion 2</summary><ul><li>FooBar Foo</li><li>Artificial intelligence</li></ul></details><article>I\'m a card!</article><article><header>Header</header>\n        Body\n        <footer>Footer</footer></article><details role="list"><summary aria-haspopup="listbox">Dropdown</summary><ul role="listbox"><li><label><input type="checkbox"/>\n              Banana\n            </label></li><li><label><input type="checkbox"/>\n              Watermelon\n            </label></li><li><label><input type="checkbox"/>\n              Apple\n            </label></li></ul></details><nav><ul><li><strong>Brand</strong></li></ul><ul><li><a href="#">Link</a></li><li><a href="#">Link</a></li><li><a href="#">Link</a></li><li><details role="list" dir="rtl"><summary aria-haspopup="listbox" role="link">Dropdown</summary><ul role="listbox"><li><a>Action</a></li><li><a>Another action</a></li><li><a>Something else here</a></li></ul></details></li></ul></nav><button expr4="expr4">Mover</button><button expr5="expr5">Colapsar</button></div><div class="content"><slot expr6="expr6"></slot></div></div>',
      [
        {
          ...
          expressions: [
            {
              type: expressionTypes.EVENT,
              name: 'onclick',
              evaluate: _scope => _scope.moveWindow
            }
          ]
        },
        {
          ...
          expressions: [
            {
              type: expressionTypes.EVENT,
              name: 'onclick',
              evaluate: _scope => _scope.toggleCollapse
            }
          ]
        },
        {
